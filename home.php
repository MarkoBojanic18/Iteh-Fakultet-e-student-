    ...
    <div class="row" style="background-color: rgba(225, 225, 208, 0.5);">
        ...
        <div class="col-md-4">
            <button id="btn-dodaj" type="button" class="btn btn-success btn-block"
                style="background-color: teal; border: 1px solid white;" data-toggle="modal" data-target="#myModal">
                Zakazi kolokvijum</button>
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="myInput" onkeyup="funkcijaZaPretragu()"
                placeholder="Pretrazi kolokvijume po predmetu" hidden>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-md-1" style="text-align: right">
                    <button id="btn-izmeni" class="btn btn-warning" data-toggle="modal"
                        data-target="#izmeniModal">Izmeni</button>

                </div>

                <div class="col-md-12" style="text-align: right">
                    <button id="btn-obrisi" class="btn btn-danger"
                        style="background-color: red; border: 1px solid white;">Obrisi</button>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-11 ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="border: 1px solid black" name="predmet"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label for="">Katedra</label>
                                        <input type="text" style="border: 1px solid black" name="katedra"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group">
                                        <label for="sala">Sala</label>
                                        <input type="sala" style="border: 1px solid black" name="sala"
                                            class="form-control" />
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
